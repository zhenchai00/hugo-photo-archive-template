			...
			loadMedia: function (src, callback) {
				...
				// Everything else
					...
					if (!this.isVideo(src)) {
						...
						// add the image protection notice 
						img.on('contextmenu', function (event) {
							event.preventDefault();
							const notice = document.getElementById("image_protection_notice");
							notice.style.left = `${event.pageX}px`;
							notice.style.top = `${event.pageY}px`;
...
$(document).ready(function() {
  $("#swipebox-slider").on("contextmenu", ".slide", function(event) {
    event.preventDefault();
    console.log("Context menu clicked on slide element");
  });
});
